...
function Navi() {
  ...
  // Logo Animation
  useEffect(() => {
    gsap.from(".logo-container", { y: -30, autoAlpha: 0, duration: 2, delay: 5.2, ease: "power2" })
  })
  ...
  useEffect(() => {
    gsap.from([".line-1", ".line-2", ".line-3"], { y: -20, autoAlpha: 0, duration: 2, delay: 5.2, stagger: 0.2, ease: "power2" })
